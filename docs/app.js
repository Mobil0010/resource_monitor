...
const translations = {
  ko: {
    ...
    pawnioTitle: "PawnIO 설치 안내", pawnioStep1Title: "첫 실행 때 창이 나타나요", pawnioStep1Body: "Windows 설치 후 Resource Monitor를 처음 실행하면 하드웨어 온도 센서를 위한 PawnIO Setup 창이 나타날 수 있습니다.",
    pawnioStep2Title: "관리자 권한을 허용해 주세요", pawnioStep2Body: "Windows의 관리자 권한 확인이 표시되면 허용하고 PawnIO 설치를 완료해 주세요. CPU와 디스크 온도 같은 센서 정보를 읽는 데 사용됩니다.",
    pawnioStep3Title: "설치하지 않아도 앱은 실행돼요", pawnioStep3Body: "PawnIO를 설치하지 않으면 앱의 기본 모니터링은 계속 사용할 수 있지만, 일부 하드웨어 온도 정보가 표시되지 않을 수 있습니다.",
  ...
  en: {
    ...
    pawnioTitle: "PawnIO setup on Windows", pawnioStep1Title: "It may appear on first launch", pawnioStep1Body: "After installing Resource Monitor on Windows, a PawnIO Setup window may appear the first time you launch the app. It is used for hardware temperature sensors.",
    pawnioStep2Title: "Allow administrator access", pawnioStep2Body: "Approve the Windows administrator prompt and complete PawnIO setup. It helps Resource Monitor read sensors such as CPU and disk temperature.",
    pawnioStep3Title: "The app still works without it", pawnioStep3Body: "You can still use the main monitoring features without PawnIO, but some hardware temperature readings may be unavailable.",
